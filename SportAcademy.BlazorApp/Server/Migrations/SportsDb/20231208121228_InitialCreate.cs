    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Sports Management", "Advanced course in sports management", new DateTime(2024, 5, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(5902), "Fall 2023", new DateTime(2023, 11, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(5897) },
                    { 2, "Sports Nutrition", "Understanding nutrition for athletic performance", new DateTime(2024, 6, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(5911), "Fall 2023", new DateTime(2024, 1, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(5906) },
                    { 3, "Sports Psychology", "Psychological aspects of sports and performance", new DateTime(2024, 7, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(5920), "Fall 2023", new DateTime(2024, 2, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(5918) },
                    { 4, "Sports Medicine", "Medical aspects of sports and athlete care", new DateTime(2024, 8, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(5927), "Fall 2023", new DateTime(2024, 3, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(5924) },
                    { 5, "Coaching Strategies", "Strategies for effective coaching in sports", new DateTime(2024, 9, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(5936), "Fall 2023", new DateTime(2024, 4, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(5934) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "123 Main Street", "john.manager@example.com", new DateTime(2023, 12, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(2660), "John Manager", "123-456-7890", "manager1.jpg" },
                    { 2, "456 Broad Avenue", "alice.admin@example.com", new DateTime(2023, 12, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(2696), "Alice Administrator", "987-654-3210", "manager2.jpg" },
                    { 3, "789 Pine Lane", "bob.lead@example.com", new DateTime(2023, 12, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(2703), "Bob Team Lead", "555-123-4567", "manager3.jpg" },
                    { 4, "890 Oak Street", "eva.coordinator@example.com", new DateTime(2023, 12, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(2710), "Eva Coordinator", "111-222-3333", "manager4.jpg" },
                    { 5, "567 Elm Road", "chris.supervisor@example.com", new DateTime(2023, 12, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(2717), "Chris Supervisor", "444-555-6666", "manager5.jpg" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "789 Elm Street", "Team Doctor", "dr.johnson@example.com", new DateTime(2023, 12, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(3590), "Dr. Johnson", "555-123-4567", "advisor1.jpg" },
                    { 2, "456 Maple Avenue", "Sports Physio", "dr.smith@example.com", new DateTime(2023, 12, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(3598), "Dr. Smith", "555-987-6543", "advisor2.jpg" },
                    { 3, "123 Oak Street", "Nutritionist", "dr.anderson@example.com", new DateTime(2023, 12, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(3605), "Dr. Anderson", "555-345-6789", "advisor3.jpg" },
                    { 4, "789 Pine Avenue", "Psychologist", "dr.williams@example.com", new DateTime(2023, 12, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(3613), "Dr. Williams", "555-678-9012", "advisor4.jpg" },
                    { 5, "101 Cedar Lane", "Rehab Specialist", "dr.davis@example.com", new DateTime(2023, 12, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(3618), "Dr. Davis", "555-234-5678", "advisor5.jpg" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "456 Oak Avenue", "Coach Smith", 1, "coach.smith@example.com", new DateTime(2023, 12, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(3206), "987-654-3210", "coach1.jpg" },
                    { 2, "789 Maple Street", "Coach Johnson", 2, "coach.johnson@example.com", new DateTime(2023, 12, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(3214), "123-456-7890", "coach2.jpg" },
                    { 3, "234 Birch Lane", "Coach Davis", 3, "coach.davis@example.com", new DateTime(2023, 12, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(3218), "555-222-3333", "coach3.jpg" },
                    { 4, "567 Pine Road", "Coach Miller", 4, "coach.miller@example.com", new DateTime(2023, 12, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(3222), "111-999-7777", "coach4.jpg" },
                    { 5, "890 Elm Avenue", "Coach Wilson", 5, "coach.wilson@example.com", new DateTime(2023, 12, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(3229), "444-888-6666", "coach5.jpg" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 1, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(6441), "Sports Science", 1, 85.5 },
                    { 2, new DateTime(2024, 2, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(6451), "Nutrition Fundamentals", 2, 92.299999999999997 },
                    { 3, new DateTime(2024, 3, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(6462), "Psychological Assessment", 3, 78.900000000000006 },
                    { 4, new DateTime(2024, 4, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(6465), "Sports Injury Management", 4, 89.099999999999994 },
                    { 5, new DateTime(2024, 5, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(6496), "Coaching Philosophies", 5, 94.700000000000003 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Training session to prepare for the season", new DateTime(2023, 12, 9, 8, 12, 27, 741, DateTimeKind.Local).AddTicks(5433), "Pre-Season Training" },
                    { 2, 2, "Focus on agility and overall conditioning", new DateTime(2024, 1, 9, 10, 12, 27, 741, DateTimeKind.Local).AddTicks(5439), "Agility and Conditioning" },
                    { 3, 3, "Drills to improve tactical understanding", new DateTime(2024, 2, 9, 9, 12, 27, 741, DateTimeKind.Local).AddTicks(5443), "Tactical Drills" },
                    { 4, 4, "Specialized training for speed and power", new DateTime(2024, 3, 9, 8, 12, 27, 741, DateTimeKind.Local).AddTicks(5447), "Speed and Power Training" },
                    { 5, 1, "Focus on player recovery and injury prevention", new DateTime(2024, 4, 9, 11, 12, 27, 741, DateTimeKind.Local).AddTicks(5503), "Recovery Session" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 12, 8, 0, 0, 0, 0, DateTimeKind.Local), true, 1 },
                    { 2, new DateTime(2024, 1, 8, 0, 0, 0, 0, DateTimeKind.Local), true, 2 },
                    { 3, new DateTime(2024, 2, 8, 0, 0, 0, 0, DateTimeKind.Local), true, 3 },
                    { 4, new DateTime(2024, 3, 8, 0, 0, 0, 0, DateTimeKind.Local), true, 4 },
                    { 5, new DateTime(2024, 4, 8, 0, 0, 0, 0, DateTimeKind.Local), true, 5 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Intensive training for the upcoming season", new DateTime(2023, 12, 15, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(5240), "Training Camp", "Sports Complex", 1, "event1.jpg", 1, new DateTime(2023, 12, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(5234) },
                    { 2, "Building team cohesion and communication", new DateTime(2024, 1, 10, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(5269), "Team Building Workshop", "Conference Center", 1, "event2.jpg", 1, new DateTime(2024, 1, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(5260) },
                    { 3, "Friendly match to assess team performance", new DateTime(2024, 2, 9, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(5283), "Scrimmage Match", "Stadium", 1, "event3.jpg", 1, new DateTime(2024, 2, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(5278) },
                    { 4, "Educating players on injury prevention techniques", new DateTime(2024, 3, 10, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(5296), "Injury Prevention Workshop", "Training Facility", 1, "event4.jpg", 1, new DateTime(2024, 3, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(5291) },
                    { 5, "Planning team strategies for the upcoming matches", new DateTime(2024, 4, 9, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(5308), "Team Strategy Session", "Team Meeting Room", 1, "event5.jpg", 1, new DateTime(2024, 4, 8, 18, 12, 27, 741, DateTimeKind.Local).AddTicks(5304) }
                });
